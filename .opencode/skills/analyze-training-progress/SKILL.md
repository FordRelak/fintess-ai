...
9. Запишите `result.json` рядом с локальным входным файлом. Если входной файл недоступен для записи или не является локальным, создайте доступный для скачивания артефакт `result.json`.
